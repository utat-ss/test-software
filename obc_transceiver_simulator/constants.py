...
class CommandOpcode(IntEnum):
    ...
    COL_DATA_BLOCK              = 0x20
    GET_AUTO_DATA_COL_ENABLE    = 0x21
    SET_AUTO_DATA_COL_ENABLE    = 0x22
    GET_AUTO_DATA_COL_PERIOD    = 0x23
    SET_AUTO_DATA_COL_PERIOD    = 0x24
    GET_AUTO_DATA_COL_TIMERS    = 0x25
    RESYNC_AUTO_DATA_COL_TIMERS = 0x26
    GET_CUR_BLOCK_NUM           = 0x30
    SET_CUR_BLOCK_NUM           = 0x31
    GET_MEM_SEC_START_ADDR      = 0x32
    SET_MEM_SEC_START_ADDR      = 0x33
    GET_MEM_SEC_END_ADDR        = 0x34
    SET_MEM_SEC_END_ADDR        = 0x35
    ERASE_MEM_PHY_SECTOR        = 0x36
    ERASE_MEM_PHY_BLOCK         = 0x37
    ERASE_ALL_MEM               = 0x38
